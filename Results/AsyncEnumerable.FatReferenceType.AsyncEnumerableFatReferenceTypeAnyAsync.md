...
|------------ |------ |---------:|----------:|----------:|-------------:|--------:|------:|------:|------:|----------:|
| ForeachLoop |   100 | 1.671 ms | 0.0075 ms | 0.0070 ms |     baseline |         |     - |     - |     - |     538 B |
|        Linq |   100 | 1.673 ms | 0.0097 ms | 0.0091 ms | 1.00x slower |   0.01x |     - |     - |     - |     568 B |
|   Hyperlinq |   100 | 1.667 ms | 0.0067 ms | 0.0063 ms | 1.00x faster |   0.01x |     - |     - |     - |     560 B |
