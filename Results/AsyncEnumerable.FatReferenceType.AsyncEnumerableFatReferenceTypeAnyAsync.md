...
|------------ |------ |---------:|---------:|---------:|-------------:|--------:|------:|------:|------:|----------:|
| ForeachLoop |   100 | 15.69 ms | 0.171 ms | 0.151 ms |     baseline |         |     - |     - |     - |     536 B |
|        Linq |   100 | 15.71 ms | 0.303 ms | 0.349 ms | 1.00x faster |   0.02x |     - |     - |     - |     552 B |
|   Hyperlinq |   100 | 15.74 ms | 0.247 ms | 0.219 ms | 1.00x slower |   0.02x |     - |     - |     - |     544 B |
