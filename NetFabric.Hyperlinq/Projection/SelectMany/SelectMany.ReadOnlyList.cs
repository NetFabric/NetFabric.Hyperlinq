...
namespace NetFabric.Hyperlinq
{
    public static partial class ReadOnlyList
    {
            ...
            where TSubEnumerator : struct, IValueEnumerator<TResult>
        {
            ...
            public ValueEnumerable.SelectEnumerable<SelectManyEnumerable<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult>, ValueEnumerator, TResult, TSelectorResult> Select<TSelectorResult>(Func<TResult, int, TSelectorResult> selector)
            ...
            public ValueEnumerable.WhereEnumerable<SelectManyEnumerable<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult>, ValueEnumerator, TResult> Where(Func<TResult, int, bool> predicate)
        ...
        public static TResult? FirstOrNull<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult>(this SelectManyEnumerable<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult> source, Func<TResult, int, bool> predicate)
            where TEnumerable : IReadOnlyList<TSource>
            where TSubEnumerable : IValueEnumerable<TResult, TSubEnumerator>
            where TSubEnumerator : struct, IValueEnumerator<TResult>
            where TResult : struct
        ...
        public static TResult? SingleOrNull<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult>(this SelectManyEnumerable<TEnumerable, TSource, TSubEnumerable, TSubEnumerator, TResult> source, Func<TResult, int, bool> predicate)
            where TEnumerable : IReadOnlyList<TSource>
            where TSubEnumerable : IValueEnumerable<TResult, TSubEnumerator>
            where TSubEnumerator : struct, IValueEnumerator<TResult>
            where TResult : struct
