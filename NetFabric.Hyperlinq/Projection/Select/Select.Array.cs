...
namespace NetFabric.Hyperlinq
{
    public static partial class ArrayExtensions
    {
            ...
            , IList<TResult>
        {
            ...
            internal SelectEnumerable(in TSource[] source, NullableSelector<TSource, TResult> selector, int skipCount, int takeCount)
            {
                this.source = source;
            ...
            public Option<TResult> FirstOption()
                => ArrayExtensions.FirstOption<TSource, TResult>(source, selector, skipCount, Count);
