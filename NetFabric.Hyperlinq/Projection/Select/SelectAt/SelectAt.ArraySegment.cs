...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Count<TSource, TResult, TSelector>(this ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector> source, Func<TResult, bool> predicate)
            where TSelector : struct, IFunction<TSource, int, TResult>
            => ValueReadOnlyCollectionExtensions.Count<ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector>, ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector>.Enumerator, TResult>(source, predicate);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int Count<TSource, TResult, TSelector>(this ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector> source, Func<TResult, int, bool> predicate)
            where TSelector : struct, IFunction<TSource, int, TResult>
            => ValueReadOnlyCollectionExtensions.Count<ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector>, ArraySegmentSelectAtEnumerable<TSource, TResult, TSelector>.Enumerator, TResult>(source, predicate);
