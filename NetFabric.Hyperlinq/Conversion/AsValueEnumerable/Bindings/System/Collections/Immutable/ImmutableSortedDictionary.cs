...
namespace NetFabric.Hyperlinq
{
    ...
    {
        // ImmutableSortedDictionary<TKey, TValue> implements IReadOnlyCollection<KeyValuePair<TKey, TValue>> and has a value-type enumerator that implements IEnumerator<TKey, TValue>
