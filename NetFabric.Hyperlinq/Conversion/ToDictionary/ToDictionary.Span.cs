...
namespace NetFabric.Hyperlinq
{
    public static partial class ArrayExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this Span<TSource> source, FunctionIn<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer = default)
            where TKey : notnull
            => ((ReadOnlySpan<TSource>)source).ToDictionary(keySelector, comparer);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey, TSource> ToDictionaryRef<TSource, TKey, TKeySelector>(this Span<TSource> source, TKeySelector keySelector, IEqualityComparer<TKey>? comparer = default)
            where TKey : notnull
            where TKeySelector : struct, IFunctionIn<TSource, TKey>
            => ((ReadOnlySpan<TSource>)source).ToDictionaryRef(keySelector, comparer);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey, TElement> ToDictionaryRef<TSource, TKey, TElement, TKeySelector, TElementSelector>(this Span<TSource> source, TKeySelector keySelector, TElementSelector elementSelector, IEqualityComparer<TKey>? comparer = default)
            where TKey : notnull
            where TKeySelector : struct, IFunctionIn<TSource, TKey>
            where TElementSelector : struct, IFunctionIn<TSource, TElement>
            => ((ReadOnlySpan<TSource>)source).ToDictionaryRef<TSource, TKey, TElement, TKeySelector, TElementSelector>(keySelector, elementSelector, comparer);
    }
}
