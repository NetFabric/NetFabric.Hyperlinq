...
namespace NetFabric.Hyperlinq
{
    public static partial class ArrayExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IMemoryOwner<TResult> ToArray<TSource, TResult>(this Memory<TSource> source, NullableSelector<TSource, TResult> selector, MemoryPool<TResult> pool)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IMemoryOwner<TResult> ToArray<TSource, TResult>(this Memory<TSource> source, NullableSelectorAt<TSource, TResult> selector, MemoryPool<TResult> pool)
            => ToArray(source.Span, selector, pool);
