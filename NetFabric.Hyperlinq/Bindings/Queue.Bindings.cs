...
namespace NetFabric.Hyperlinq
{
    public static class QueueBindings
    {
        ...
        public static TSource First<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
        ...
        public static TSource FirstOrDefault<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
        ...
        public static TSource? FirstOrNull<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
            where TSource : struct
        ...
        public static TSource Single<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
        ...
        public static TSource SingleOrDefault<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
        ...
        public static TSource? SingleOrNull<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
            where TSource : struct
