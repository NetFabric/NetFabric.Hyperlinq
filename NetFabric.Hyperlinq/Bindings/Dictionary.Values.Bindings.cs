...
namespace NetFabric.Hyperlinq
{
    public static class DictionaryValuesBindings
    {
        ...
        public static TValue First<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
        ...
        public static TValue FirstOrDefault<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
        ...
        public static TValue? FirstOrNull<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
            where TValue : struct
        ...
        public static TValue Single<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
        ...
        public static TValue SingleOrDefault<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
        ...
        public static TValue? SingleOrNull<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source, Func<TValue, int, bool> predicate)
            where TValue : struct
