...
namespace NetFabric.Hyperlinq
{
    public static class ListBindings
    {
        ...
        public static bool All<TSource>(this List<TSource> source, Func<TSource, long, bool> predicate)
        ...
        public static bool Any<TSource>(this List<TSource> source, Func<TSource, long, bool> predicate)
