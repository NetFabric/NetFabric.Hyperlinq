...
namespace NetFabric.Hyperlinq
{
    public static partial class ReadOnlyMemoryBindings
    {
        ...
        public static ValueEnumerable<TSource> AsValueEnumerable<TSource>(this ReadOnlyMemory<TSource> source)
            => new(source);
            ...
            , IList<TSource>
        {
            ...
            internal ValueEnumerable(ReadOnlyMemory<TSource> source)
                => this.source = source;
            ...
            public ref struct ForeachEnumerator
            {
                ...
                internal ForeachEnumerator(ReadOnlyMemory<TSource> source)
                {
