...
namespace NetFabric.Hyperlinq
{
    ...
    public static partial class ImmutableQueueBindings
    {
        ...
        public static Option<TSource> First<TSource>(this ImmutableQueue<TSource> source)
            => ValueEnumerableExtensions.FirstOption<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source));
        ...
        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this ImmutableQueue<TSource> source, NullableSelector<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer)
        ...
        public static Dictionary<TKey, TElement> ToDictionary<TSource, TKey, TElement>(this ImmutableQueue<TSource> source, NullableSelector<TSource, TKey> keySelector, NullableSelector<TSource, TElement> elementSelector)
