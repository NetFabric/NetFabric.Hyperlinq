...
namespace NetFabric.Hyperlinq
{
    public static class ImmutableStackBindings
    {
        ...
        [Pure]
        public static long LongCount<TSource>(this ImmutableStack<TSource> source, Func<TSource, bool> predicate)
        ...
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this ImmutableStack<TSource> source, Func<TSource, bool> predicate)
        ...
        [Pure]
        public static MaybeAt<TSource> TryFirst<TSource>(this ImmutableStack<TSource> source, Func<TSource, int, bool> predicate)
            => ValueEnumerable.TryFirst<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
