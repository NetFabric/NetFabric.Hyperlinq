...
namespace NetFabric.Hyperlinq
{
    ...
    public static class ImmutableStackBindings
    {
        ...
        [Pure]
        public static int Count<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static int Count<TSource>(this ImmutableStack<TSource> source, PredicateAt<TSource> predicate)
            => ValueEnumerable.Count<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);

        [Pure]
        public static long LongCount<TSource>(this ImmutableStack<TSource> source)
            => ValueEnumerable.LongCount<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source));
        [Pure]
        public static long LongCount<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static TSource First<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TSource FirstOrDefault<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this ImmutableStack<TSource> source)
            => ValueEnumerable.TryFirst<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source));
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static MaybeAt<TSource> TryFirst<TSource>(this ImmutableStack<TSource> source, PredicateAt<TSource> predicate)
            => ValueEnumerable.TryFirst<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
        ...
        [Pure]
        public static TSource Single<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TSource SingleOrDefault<TSource>(this ImmutableStack<TSource> source, Predicate<TSource> predicate)
        ...
        public static void ForEach<TSource>(this ImmutableStack<TSource> source, Action<TSource, int> action)
            => ValueEnumerable.ForEach<ValueWrapper<TSource>, ValueWrapper<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), action);
