...
namespace NetFabric.Hyperlinq
{
    public static class SortedDictionaryValuesBindings
    {
        ...
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source)
            => source.Count;
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, PredicateAt<TValue> predicate)
            => ValueReadOnlyCollection.Count<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source), predicate);

        [Pure]
        public static long LongCount<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source)
            => ValueEnumerable.LongCount<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source));
        [Pure]
        public static long LongCount<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
            => ValueEnumerable.LongCount<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [Pure]
        public static TValue ElementAt<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, int index)
        ...
        [Pure]
        public static TValue First<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TValue FirstOrDefault<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        [Pure]
        public static Maybe<TValue> TryFirst<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source)
        ...
        [Pure]
        public static Maybe<TValue> TryFirst<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        [Pure]
        public static MaybeAt<TValue> TryFirst<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, PredicateAt<TValue> predicate)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [Pure]
        public static TValue Single<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TValue SingleOrDefault<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Predicate<TValue> predicate)
        ...
        public static void ForEach<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Action<TValue> action)
            => ValueReadOnlyCollection.ForEach<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source), action);
        public static void ForEach<TKey, TValue>(this SortedDictionary<TKey, TValue>.ValueCollection source, Action<TValue, int> action)
            => ValueReadOnlyCollection.ForEach<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source), action);
