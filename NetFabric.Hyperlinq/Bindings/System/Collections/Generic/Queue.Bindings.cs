...
namespace NetFabric.Hyperlinq
{
    public static class QueueBindings
    {
        ...
        [Pure]
        public static long LongCount<TSource>(this Queue<TSource> source, Func<TSource, bool> predicate)
        ...
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this Queue<TSource> source, Func<TSource, bool> predicate)
        ...
        [Pure]
        public static MaybeAt<TSource> TryFirst<TSource>(this Queue<TSource> source, Func<TSource, int, bool> predicate)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
