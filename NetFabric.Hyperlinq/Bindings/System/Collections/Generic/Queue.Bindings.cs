...
namespace NetFabric.Hyperlinq
{
    public static class QueueBindings
    {
        ...
        public static int Count<TSource>(this Queue<TSource> source)
            => source.Count;
        [Pure]
        public static int Count<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static int Count<TSource>(this Queue<TSource> source, PredicateAt<TSource> predicate)
            => ValueReadOnlyCollection.Count<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);

        [Pure]
        public static long LongCount<TSource>(this Queue<TSource> source)
            => ValueEnumerable.LongCount<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source));
        [Pure]
        public static long LongCount<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
            => ValueEnumerable.LongCount<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
        ...
        [Pure]
        public static TSource First<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TSource FirstOrDefault<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this Queue<TSource> source)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source));
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static MaybeAt<TSource> TryFirst<TSource>(this Queue<TSource> source, PredicateAt<TSource> predicate)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
        ...
        [Pure]
        public static TSource Single<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TSource SingleOrDefault<TSource>(this Queue<TSource> source, Predicate<TSource> predicate)
        ...
        public static void ForEach<TSource>(this Queue<TSource> source, Action<TSource, int> action)
            => ValueReadOnlyCollection.ForEach<ValueWrapper<TSource>, Queue<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), action);
