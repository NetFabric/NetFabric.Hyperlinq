...
namespace NetFabric.Hyperlinq
{
    public static class SortedDictionaryBindings
    {
        ...
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue> source)
            => source.Count;
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Predicate<KeyValuePair<TKey, TValue>> predicate)
        ...
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue> source, PredicateAt<KeyValuePair<TKey, TValue>> predicate)
            => ValueReadOnlyCollection.Count<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.Enumerator, KeyValuePair<TKey, TValue>>(new ValueWrapper<TKey, TValue>(source), predicate);

        [Pure]
        public static long LongCount<TKey, TValue>(this SortedDictionary<TKey, TValue> source)
            => ValueEnumerable.LongCount<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.Enumerator, KeyValuePair<TKey, TValue>>(new ValueWrapper<TKey, TValue>(source));
        [Pure]
        public static long LongCount<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Predicate<KeyValuePair<TKey, TValue>> predicate)
            => ValueEnumerable.LongCount<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.Enumerator, KeyValuePair<TKey, TValue>>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [Pure]
        public static Maybe<KeyValuePair<TKey, TValue>> TryFirst<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Predicate<KeyValuePair<TKey, TValue>> predicate)
        ...
        [Pure]
        public static MaybeAt<KeyValuePair<TKey, TValue>> TryFirst<TKey, TValue>(this SortedDictionary<TKey, TValue> source, PredicateAt<KeyValuePair<TKey, TValue>> predicate)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.Enumerator, KeyValuePair<TKey, TValue>>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [Pure]
        public static KeyValuePair<TKey, TValue> Single<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Predicate<KeyValuePair<TKey, TValue>> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static KeyValuePair<TKey, TValue> SingleOrDefault<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Predicate<KeyValuePair<TKey, TValue>> predicate)
        ...
        public static void ForEach<TKey, TValue>(this SortedDictionary<TKey, TValue> source, Action<KeyValuePair<TKey, TValue>, int> action)
            => ValueReadOnlyCollection.ForEach<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.Enumerator, KeyValuePair<TKey, TValue>>(new ValueWrapper<TKey, TValue>(source), action);
