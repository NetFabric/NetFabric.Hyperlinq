...
namespace NetFabric.Hyperlinq
{
    public static partial class DictionaryValuesBindings
    {
        ...
        public static Option<TValue> First<TKey, TValue>(this Dictionary<TKey, TValue>.ValueCollection source)
            => ValueReadOnlyCollectionExtensions.FirstOption<ValueWrapper<TKey, TValue>, Dictionary<TKey, TValue>.ValueCollection.Enumerator, TValue>(new ValueWrapper<TKey, TValue>(source));
