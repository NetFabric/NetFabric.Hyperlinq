...
namespace NetFabric.Hyperlinq
{
    public static class SortedDictionaryKeysBindings
    {
        ...
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source)
            => source.Count;
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, Predicate<TKey> predicate)
        ...
        [Pure]
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, PredicateAt<TKey> predicate)
            => ValueReadOnlyCollection.Count<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [Pure]
        public static long LongCount<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, Predicate<TKey> predicate)
        ...
        [Pure]
        public static TKey First<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, Predicate<TKey> predicate)
        ...
        [Pure]
        public static TKey Single<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, Predicate<TKey> predicate)
        ...
        [Pure]
        [return: MaybeNull]
        public static TKey SingleOrDefault<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, Predicate<TKey> predicate)
