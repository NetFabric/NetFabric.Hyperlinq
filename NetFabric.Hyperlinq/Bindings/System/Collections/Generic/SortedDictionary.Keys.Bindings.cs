...
namespace NetFabric.Hyperlinq
{
    public static partial class SortedDictionaryKeysBindings
    {
        ...
        public static ValueEnumerableExtensions.WhereEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, ValuePredicate<TKey>> Where<TKey, TValue>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
        ...
        public static ValueEnumerableExtensions.WhereAtEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, ValuePredicateAt<TKey>> Where<TKey, TValue>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
        ...
        public static Dictionary<TKey2, TKey> ToDictionary<TKey, TValue, TKey2>(this SortedDictionary<TKey, TValue>.KeyCollection source, Selector<TKey, TKey2> keySelector, IEqualityComparer<TKey2>? comparer = default)
            where TKey : notnull
            where TKey2 : notnull
