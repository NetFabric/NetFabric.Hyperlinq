...
namespace NetFabric.Hyperlinq
{
    public static partial class SortedDictionaryKeysBindings
    {
        ...
        public static int Count<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source)
            where TKey : notnull
            => ValueReadOnlyCollectionExtensions.Count<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey>(new ValueWrapper<TKey, TValue>(source));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool All<TKey, TValue, TPredicate>(this SortedDictionary<TKey, TValue>.KeyCollection source, TPredicate predicate = default)
            where TKey : notnull
            where TPredicate : struct, IFunction<TKey, bool>
            => ValueReadOnlyCollectionExtensions.All<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TPredicate>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool AllAt<TKey, TValue, TPredicate>(this SortedDictionary<TKey, TValue>.KeyCollection source, TPredicate predicate = default)
            where TKey : notnull
            where TPredicate : struct, IFunction<TKey, int, bool>
            => ValueReadOnlyCollectionExtensions.AllAt<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TPredicate>(new ValueWrapper<TKey, TValue>(source), predicate);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Any<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source)
            where TKey : notnull
            => ValueReadOnlyCollectionExtensions.Any<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey>(new ValueWrapper<TKey, TValue>(source));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Any<TKey, TValue, TPredicate>(this SortedDictionary<TKey, TValue>.KeyCollection source, TPredicate predicate = default)
            where TKey : notnull
            where TPredicate : struct, IFunction<TKey, bool>
            => ValueReadOnlyCollectionExtensions.Any<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TPredicate>(new ValueWrapper<TKey, TValue>(source), predicate);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool AnyAt<TKey, TValue, TPredicate>(this SortedDictionary<TKey, TValue>.KeyCollection source, TPredicate predicate = default)
            where TKey : notnull
            where TPredicate : struct, IFunction<TKey, int, bool>
            => ValueReadOnlyCollectionExtensions.AnyAt<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TPredicate>(new ValueWrapper<TKey, TValue>(source), predicate);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Contains<TKey, TValue>(this SortedDictionary<TKey, TValue>.KeyCollection source, TKey value, IEqualityComparer<TKey>? comparer = default)
            where TKey : notnull
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueReadOnlyCollectionExtensions.SelectEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, FunctionWrapper<TKey, TResult>> Select<TKey, TValue, TResult>(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueReadOnlyCollectionExtensions.SelectEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, TSelector> Select<TKey, TValue, TResult, TSelector>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
            TSelector selector = default)
            where TKey : notnull
            where TSelector : struct, IFunction<TKey, TResult>
            => ValueReadOnlyCollectionExtensions.Select<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, TSelector>(new ValueWrapper<TKey, TValue>(source), selector);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueReadOnlyCollectionExtensions.SelectAtEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, FunctionWrapper<TKey, int, TResult>> Select<TKey, TValue, TResult>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueReadOnlyCollectionExtensions.SelectAtEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, TSelector> SelectAt<TKey, TValue, TResult, TSelector>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
            TSelector selector = default)
            where TKey : notnull
            where TSelector : struct, IFunction<TKey, int, TResult>
            => ValueReadOnlyCollectionExtensions.SelectAt<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TResult, TSelector>(new ValueWrapper<TKey, TValue>(source), selector);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueEnumerableExtensions.SelectManyEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TSubEnumerable, TSubEnumerator, TResult, FunctionWrapper<TKey, TSubEnumerable>> SelectMany<TKey, TValue, TSubEnumerable, TSubEnumerator, TResult>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueEnumerableExtensions.SelectManyEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TSubEnumerable, TSubEnumerator, TResult, TSelector> SelectMany<TKey, TValue, TSubEnumerable, TSubEnumerator, TResult, TSelector>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
            TSelector selector = default)
            where TSubEnumerable : IValueEnumerable<TResult, TSubEnumerator>
            where TSubEnumerator : struct, IEnumerator<TResult>
            ...
            => ValueEnumerableExtensions.SelectMany<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TSubEnumerable, TSubEnumerator, TResult, TSelector>(new ValueWrapper<TKey, TValue>(source), selector);
            
        #endregion
        #region Filtering

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueEnumerableExtensions.WhereEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, FunctionWrapper<TKey, bool>> Where<TKey, TValue>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueEnumerableExtensions.WhereAtEnumerable<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, FunctionWrapper<TKey, int, bool>> Where<TKey, TValue>(
            this SortedDictionary<TKey, TValue>.KeyCollection source,
...
#pragma warning restore HLQ005 // Avoid Single() and SingleOrDefault()
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey2, TKey> ToDictionary<TKey, TValue, TKey2>(this SortedDictionary<TKey, TValue>.KeyCollection source, Func<TKey, TKey2> keyFunc, IEqualityComparer<TKey2>? comparer = default)
            where TKey : notnull
            where TKey2 : notnull
            => ValueReadOnlyCollectionExtensions.ToDictionary<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TKey2>(new ValueWrapper<TKey, TValue>(source), keyFunc, comparer);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey2, TKey> ToDictionary<TKey, TValue, TKey2, TKeySelector>(this SortedDictionary<TKey, TValue>.KeyCollection source, TKeySelector keyFunc, IEqualityComparer<TKey2>? comparer = default)
            where TKey : notnull
            where TKey2 : notnull
            where TKeySelector : struct, IFunction<TKey, TKey2>
            => ValueReadOnlyCollectionExtensions.ToDictionary<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TKey2, TKeySelector>(new ValueWrapper<TKey, TValue>(source), keyFunc, comparer);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey2, TElement> ToDictionary<TKey, TValue, TKey2, TElement>(this SortedDictionary<TKey, TValue>.KeyCollection source, Func<TKey, TKey2> keyFunc, Func<TKey, TElement> elementFunc, IEqualityComparer<TKey2>? comparer = default)
            where TKey : notnull
            where TKey2 : notnull
            => ValueReadOnlyCollectionExtensions.ToDictionary<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TKey2, TElement>(new ValueWrapper<TKey, TValue>(source), keyFunc, elementFunc, comparer);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Dictionary<TKey2, TElement> ToDictionary<TKey, TValue, TKey2, TElement, TKeySelector, TElementSelector>(this SortedDictionary<TKey, TValue>.KeyCollection source, TKeySelector keyFunc, TElementSelector elementFunc, IEqualityComparer<TKey2>? comparer = default)
            where TKey : notnull
            where TKey2 : notnull
            where TKeySelector : struct, IFunction<TKey, TKey2>
            where TElementSelector : struct, IFunction<TKey, TElement>
            => ValueReadOnlyCollectionExtensions.ToDictionary<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey, TKey2, TElement, TKeySelector, TElementSelector>(new ValueWrapper<TKey, TValue>(source), keyFunc, elementFunc, comparer);
            ...
            where TKey : notnull
        {
            ...
            => ValueReadOnlyCollectionExtensions.ToArray<ValueWrapper<TKey, TValue>, SortedDictionary<TKey, TValue>.KeyCollection.Enumerator, TKey>(this);
        }
