...
namespace NetFabric.Hyperlinq
{
    public static class LinkedListBindings
    {
        ...
        [Pure]
        public static Maybe<TSource> TryElementAt<TSource>(this LinkedList<TSource> source, int index)
            => ValueReadOnlyCollection.TryElementAt<ValueWrapper<TSource>, LinkedList<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), index);
        ...
        [Pure]
        public static Maybe<TSource> TryFirst<TSource>(this LinkedList<TSource> source, Predicate<TSource> predicate)
        ...
        [Pure]
        public static MaybeAt<TSource> TryFirst<TSource>(this LinkedList<TSource> source, PredicateAt<TSource> predicate)
            => ValueReadOnlyCollection.TryFirst<ValueWrapper<TSource>, LinkedList<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), predicate);
        ...
        public static void ForEach<TSource>(this LinkedList<TSource> source, Action<TSource, int> action)
            => ValueReadOnlyCollection.ForEach<ValueWrapper<TSource>, LinkedList<TSource>.Enumerator, TSource>(new ValueWrapper<TSource>(source), action);
