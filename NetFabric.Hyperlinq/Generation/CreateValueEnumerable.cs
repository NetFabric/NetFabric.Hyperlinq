    ...
    public static partial class ValueEnumerable
{
            ...
            where TEnumerator : struct, IValueEnumerator<TSource>
        {
            ...
            public SelectEnumerable<CreateValueEnumerable<TEnumerator, TSource>, TEnumerator, TSource, TResult> Select<TResult>(Func<TSource, long, TResult> selector) 
            ...
            public WhereEnumerable<CreateValueEnumerable<TEnumerator, TSource>, TEnumerator, TSource> Where(Func<TSource, long, bool> predicate) 
        ...
        public static TSource? FirstOrNull<TEnumerator, TSource>(this CreateValueEnumerable<TEnumerator, TSource> source, Func<TSource, long, bool> predicate)
            where TEnumerator : struct, IValueEnumerator<TSource>
            where TSource : struct
        ...
        public static TSource? SingleOrNull<TEnumerator, TSource>(this CreateValueEnumerable<TEnumerator, TSource> source, Func<TSource, long, bool> predicate)
            where TEnumerator : struct, IValueEnumerator<TSource>
            where TSource : struct
