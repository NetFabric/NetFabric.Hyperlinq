...
namespace NetFabric.Hyperlinq
{
    ...
    {
        static bool Contains<TSource>(this IReadOnlyCollection<TSource> source, [AllowNull] TSource value)
        {
            if (source.Count == 0)
                return false;
            ...
            static bool ValueContains(IReadOnlyCollection<TSource> source, [AllowNull] TSource value)
            {
            ...
            static bool ReferenceContains(IReadOnlyCollection<TSource> source, [AllowNull] TSource value)
            {
