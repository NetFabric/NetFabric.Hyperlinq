...
namespace NetFabric.Hyperlinq
{
    public static partial class SortedDictionaryValuesBindings
    {
        public readonly partial struct ValueWrapper<TKey,TValue>
        {
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly System.Buffers.IMemoryOwner<TResult> ToArray<TSource,TResult>(NetFabric.Hyperlinq.NullableSelector<TValue, TResult> selector,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.SortedDictionaryValuesBindings.ValueWrapper<TKey, TValue>,System.Collections.Generic.SortedDictionary<TKey, TValue>.ValueCollection.Enumerator,TValue,TResult>(this,selector,pool);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly System.Buffers.IMemoryOwner<TResult> ToArray<TSource,TResult>(NetFabric.Hyperlinq.NullableSelectorAt<TValue, TResult> selector,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.SortedDictionaryValuesBindings.ValueWrapper<TKey, TValue>,System.Collections.Generic.SortedDictionary<TKey, TValue>.ValueCollection.Enumerator,TValue,TResult>(this,selector,pool);
