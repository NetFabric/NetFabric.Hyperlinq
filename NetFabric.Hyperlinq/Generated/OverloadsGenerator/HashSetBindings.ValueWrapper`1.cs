...
namespace NetFabric.Hyperlinq
{
    public static partial class HashSetBindings
    {
        public readonly partial struct ValueWrapper<TSource>
        {
            ...
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.HashSetBindings.ValueWrapper<TSource>,System.Collections.Generic.HashSet<TSource>.Enumerator,TSource,TResult>(this,selector,pool);
            ...
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.Any<NetFabric.Hyperlinq.HashSetBindings.ValueWrapper<TSource>,System.Collections.Generic.HashSet<TSource>.Enumerator,TSource>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.ValueEnumerableExtensions.SelectManyEnumerable<NetFabric.Hyperlinq.HashSetBindings.ValueWrapper<TSource>,System.Collections.Generic.HashSet<TSource>.Enumerator,TSource,TSubEnumerable,TSubEnumerator,TResult> SelectMany<TSubEnumerable,TResult,TSubEnumerator>(NetFabric.Hyperlinq.Selector<TSource, TSubEnumerable> selector)
