...
namespace NetFabric.Hyperlinq
{
    public static partial class ValueEnumerableExtensions
    {
        public readonly partial struct AsyncValueEnumerableWrapper<TEnumerable,TEnumerator,TSource> where TEnumerable : notnull,NetFabric.Hyperlinq.IValueEnumerable<TSource, TEnumerator> where TEnumerator : struct,System.Collections.Generic.IEnumerator<TSource>
        {
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.ContainsAsync<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource>(this,value,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAsync<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAtAsync<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicate<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicate<TSource> predicate)
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate> Where(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicateAt<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicateAt<TSource> predicate)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource>(this,predicate);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate> WhereAt(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAt<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource> AsAsyncValueEnumerable(System.Func<TEnumerable, System.Threading.CancellationToken, TEnumerator> getAsyncEnumerator)
            => NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsAsyncValueEnumerable<NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,NetFabric.Hyperlinq.ValueEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>.AsyncEnumerator,TSource>(this,getAsyncEnumerator);
