...
namespace NetFabric.Hyperlinq
{
    public static partial class AsyncEnumerableExtensions
    {
        public readonly partial struct AsyncValueEnumerableWrapper<TEnumerable,TEnumerator,TSource> where TEnumerable : notnull,System.Collections.Generic.IAsyncEnumerable<TSource> where TEnumerator : struct,System.Collections.Generic.IAsyncEnumerator<TSource>
        {
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.ContainsAsync<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource>(this,value,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAsync<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAtAsync<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.SelectAtEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TResult> Select(NetFabric.Hyperlinq.AsyncSelectorAt<TSource, TResult> selector)
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicate<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicate<TSource> predicate)
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate> Where(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicateAt<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicateAt<TSource> predicate)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource>(this,predicate);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate> WhereAt(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAt<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.SelectEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TResult> Select(NetFabric.Hyperlinq.AsyncSelector<TSource, TResult> selector)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Select<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource,TResult>(this,selector);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource> AsAsyncValueEnumerable(System.Func<TEnumerable, System.Threading.CancellationToken, TEnumerator> getAsyncEnumerator)
            => NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsAsyncValueEnumerable<NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<TEnumerable, TEnumerator, TSource>,TEnumerator,TSource>(this,getAsyncEnumerator);
