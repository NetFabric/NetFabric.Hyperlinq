...
namespace NetFabric.Hyperlinq
{
    public static partial class AsyncValueEnumerable
    {
        public readonly partial struct ReturnEnumerable<TSource>
        {
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.ContainsAsync<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource>(this,value,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAsync<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.AllAtAsync<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate>(this,predicate,cancellationToken);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicate<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicate<TSource> predicate)
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereEnumerable<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate> Where(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,NetFabric.Hyperlinq.AsyncValuePredicateAt<TSource>> Where(NetFabric.Hyperlinq.AsyncPredicateAt<TSource> predicate)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.Where<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource>(this,predicate);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAtEnumerable<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate> WhereAt(TPredicate predicate = default)
            => NetFabric.Hyperlinq.AsyncValueEnumerableExtensions.WhereAt<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource,TPredicate>(this,predicate);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public readonly NetFabric.Hyperlinq.AsyncEnumerableExtensions.AsyncValueEnumerableWrapper<NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>,NetFabric.Hyperlinq.AsyncValueEnumerable.ReturnEnumerable<TSource>.DisposableEnumerator,TSource> AsAsyncValueEnumerable(System.Func<TEnumerable, System.Threading.CancellationToken, TEnumerator> getAsyncEnumerator)
