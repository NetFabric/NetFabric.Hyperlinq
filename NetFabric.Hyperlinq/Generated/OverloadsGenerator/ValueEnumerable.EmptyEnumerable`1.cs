...
namespace NetFabric.Hyperlinq
{
    public static partial class ValueEnumerable
    {
        public partial class EmptyEnumerable<TSource>
        {
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public  System.Buffers.IMemoryOwner<TResult> ToArray<TResult>(NetFabric.Hyperlinq.NullableSelector<TSource, TResult> selector,int offset,int count,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ReadOnlyListExtensions.ToArray<NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>,TSource,TResult>(this,selector,offset,count,pool);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public  System.Buffers.IMemoryOwner<TResult> ToArray<TResult>(NetFabric.Hyperlinq.NullableSelectorAt<TSource, TResult> selector,int offset,int count,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ReadOnlyListExtensions.ToArray<NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>,TSource,TResult>(this,selector,offset,count,pool);
            ...
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public  System.Buffers.IMemoryOwner<TResult> ToArray<TResult>(NetFabric.Hyperlinq.NullableSelector<TSource, TResult> selector,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>,NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>.DisposableEnumerator,TSource,TResult>(this,selector,pool);

            [GeneratedCode("NetFabric.Hyperlinq.SourceGenerator", "1.0.0")]
            [DebuggerNonUserCode]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public  System.Buffers.IMemoryOwner<TResult> ToArray<TResult>(NetFabric.Hyperlinq.NullableSelectorAt<TSource, TResult> selector,System.Buffers.MemoryPool<TResult> pool)
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>,NetFabric.Hyperlinq.ValueEnumerable.EmptyEnumerable<TSource>.DisposableEnumerator,TSource,TResult>(this,selector,pool);
