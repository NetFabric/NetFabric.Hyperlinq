...
namespace NetFabric.Hyperlinq
{
    public static partial class ReadOnlyListExtensions
    {
        public readonly partial struct SkipTakeEnumerable<TList,TSource> where TList : notnull,System.Collections.Generic.IReadOnlyList<TSource>
        {
            ...
            => NetFabric.Hyperlinq.ReadOnlyListExtensions.ToArray<NetFabric.Hyperlinq.ReadOnlyListExtensions.SkipTakeEnumerable<TList, TSource>,TSource,TResult>(this,selector,offset,count,pool);
            ...
            => NetFabric.Hyperlinq.ValueReadOnlyCollectionExtensions.ToArray<NetFabric.Hyperlinq.ReadOnlyListExtensions.SkipTakeEnumerable<TList, TSource>,NetFabric.Hyperlinq.ReadOnlyListExtensions.SkipTakeEnumerable<TList, TSource>.DisposableEnumerator,TSource,TResult>(this,selector,pool);
