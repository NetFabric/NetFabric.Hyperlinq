...
namespace NetFabric.Hyperlinq
{
    public static partial class Enumerable
    {
            ...
            where TEnumerator : IEnumerator<TSource>
        {
            ...
            public ValueEnumerable.SelectEnumerable<SkipTakeEnumerable<TEnumerable, TEnumerator, TSource>, ValueEnumerator, TSource, TResult> Select<TResult>(Func<TSource, TResult> selector)
