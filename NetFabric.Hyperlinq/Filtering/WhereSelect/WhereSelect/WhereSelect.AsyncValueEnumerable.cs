...
#pragma warning restore IDE1006 // Naming Styles
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ValueTask<int> CountAsync(Func<TResult, CancellationToken, ValueTask<bool>> predicate, CancellationToken cancellationToken = default)
                => CountAsync(new AsyncFunctionWrapper<TResult, bool>(predicate), cancellationToken);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ValueTask<int> CountAsync(Func<TResult, int, CancellationToken, ValueTask<bool>> predicate, CancellationToken cancellationToken = default)
                => CountAtAsync(new AsyncFunctionWrapper<TResult, int, bool>(predicate), cancellationToken);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public WhereEnumerable<WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>, Enumerator, TResult, AsyncFunctionWrapper<TResult, bool>> Where(Func<TResult, CancellationToken, ValueTask<bool>> predicate)
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public WhereAtEnumerable<WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>, Enumerator, TResult, AsyncFunctionWrapper<TResult, int, bool>> Where(Func<TResult, int, CancellationToken, ValueTask<bool>> predicate)
                => this.Where<WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult, TPredicate, TSelector>, Enumerator, TResult>(predicate);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public ValueTask<IMemoryOwner<TResult>> ToArrayAsync(ArrayPool<TResult> pool, CancellationToken cancellationToken = default, bool clearOnDispose = default)
            ...
            public ValueTask<Dictionary<TKey, TResult>> ToDictionaryAsync<TKey>(Func<TResult, CancellationToken, ValueTask<TKey>> keySelector, IEqualityComparer<TKey>? comparer = default, CancellationToken cancellationToken = default)
                where TKey : notnull
                => ToDictionaryAsync(new AsyncFunctionWrapper<TResult, TKey>(keySelector), comparer, cancellationToken);
