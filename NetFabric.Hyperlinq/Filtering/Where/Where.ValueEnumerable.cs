...
namespace NetFabric.Hyperlinq
{
    public static partial class ValueEnumerable
    {
            ...
            where TEnumerator : struct, IValueEnumerator<TSource>
        {
            ...
            public ValueEnumerable.WhereSelectEnumerable<TEnumerable, TEnumerator, TSource, TResult> Select<TResult>(Func<TSource, int, TResult> selector)
            ...
            public ValueEnumerable.WhereEnumerable<TEnumerable, TEnumerator, TSource> Where(Func<TSource, int, bool> predicate)
            {
