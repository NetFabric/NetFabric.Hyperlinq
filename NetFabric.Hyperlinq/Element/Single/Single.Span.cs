...
namespace NetFabric.Hyperlinq
{
    public static partial class SpanExtensions
    {
        ...
        [Pure]
        public static ref TSource Single<TSource>(this Span<TSource> source, Predicate<TSource> predicate)
        {
        ...
        [Pure]
        public static ref TSource Single<TSource>(this Span<TSource> source, PredicateAt<TSource> predicate)
        {
            if (predicate is null) Throw.ArgumentNullException(nameof(predicate));
        ...
        [Pure]
        public static ref TSource Single<TSource>(this Span<TSource> source, PredicateAt<TSource> predicate, out int index)
        {
            if (predicate is null) Throw.ArgumentNullException(nameof(predicate));
