...
namespace NetFabric.Hyperlinq
{
    public static partial class SpanExtensions
    {
        ...
        static void ForEach<TSource>(this Span<TSource> source, Action<TSource> action, int skipCount, int takeCount)
        {
        ...
        static void ForEach<TSource>(this Span<TSource> source, Action<TSource, int> action, int skipCount, int takeCount)
        {
            var end = skipCount + takeCount;
            for (var index = skipCount; index < end; index++)
