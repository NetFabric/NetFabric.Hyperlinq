...
- [enumerable.ContainsAsync()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32ContainsAsync.md)
- [enumerable.Distinct()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32Distinct.md)
- [enumerable.Select()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32Select.md)
- [enumerable.Skip().Take().Select()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32SkipTakeSelect.md)
- [enumerable.Skip().Take().Where()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32SkipTakeWhere.md)
- [enumerable.SumAsync()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32SumAsync.md)
- [enumerable.Where()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32Where.md)
- [enumerable.Where().CountAsync()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32WhereCountAsync.md)
- [enumerable.Where().Select()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32WhereSelect.md)
- [enumerable.Where().Select().ToArrayAsync()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32WhereSelectToArrayAsync.md)
- [enumerable.Where().Select().ToListAsync()](Results/AsyncEnumerable.Int32.AsyncEnumerableInt32WhereSelectToListAsync.md)

### `IAsyncEnumerable<FatReferenceType>`
- [enumerable.AnyAsync()](Results/AsyncEnumerable.FatReferenceType.AsyncEnumerableFatReferenceTypeAnyAsync.md)
- [enumerable.FirstOrDefaultAsync()](Results/AsyncEnumerable.FatReferenceType.AsyncEnumerableFatReferenceTypeFirstOrDefaultAsync.md)
