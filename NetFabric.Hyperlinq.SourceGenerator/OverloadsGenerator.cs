    ...
    public class OverloadsGenerator: ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            if (serializeSource)
            {
                ...
                generatedPath = Path.Combine("c:/Users/antao/Generated", nameof(OverloadsGenerator));
        ...
        void GenerateExtensionMethod(CodeBuilder builder, INamedTypeSymbol extendedType, IMethodSymbol implementedTypeMethod, ITypeSymbol enumerableType, ITypeSymbol enumeratorType, string generatedCodeAttribute, ImmutableArray<(string, string, bool)> genericsMapping)
        {
            var typeParameters = extendedType.ExtractMethodTypeArguments(implementedTypeMethod, genericsMapping)
                .ToArray();
