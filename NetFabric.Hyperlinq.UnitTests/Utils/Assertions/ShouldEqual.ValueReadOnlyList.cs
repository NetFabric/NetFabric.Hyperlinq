...
{
    public static class ValueReadOnlyList
    {
            ...
            where TEnumerator : struct, IEnumerator<TSource>
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    if (!EqualityComparer<TSource>.Default.Equals(source[index], expectedEnumerator.Current))
                        throw new Exception($"Indexer item at index {index} is {source[index]} but expected {expectedEnumerator.Current}.");
