...
namespace NetFabric.Hyperlinq.UnitTests
{
    public partial class AsyncValueEnumerableTests
    {
        ...
        //         .Skip<Wrap.AsyncValueEnumerable<int>, Wrap.AsyncEnumerator<int>, int>(wrapped, count);
        ...
        //     // Act
        //     var result = AsyncValueEnumerable
        //         .Skip<Wrap.AsyncValueEnumerable<int>, Wrap.AsyncEnumerator<int>, int>(wrapped, count0)
        //         .Skip(count1);
        ...
        //     // Act
        //     var result = AsyncValueEnumerable
        //         .Skip<Wrap.AsyncValueEnumerable<int>, Wrap.AsyncEnumerator<int>, int>(wrapped, skipCount)
        //         .Take(takeCount);
