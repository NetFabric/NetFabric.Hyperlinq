...
namespace NetFabric.Hyperlinq.UnitTests
{
    public class SkipTakeReadOnlyCollectionTests
    {
        ...
        public void SkipTake_With_ValidData_Should_Succeed(IReadOnlyCollection<int> source, int skipCount, int takeCount, IReadOnlyCollection<int> expected)
        {
            // Arrange

            // Act
            var result = ReadOnlyCollection.SkipTake<IReadOnlyCollection<int>, IEnumerator<int>, int>(source, skipCount, takeCount);
