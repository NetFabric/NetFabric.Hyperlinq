...
namespace NetFabric.Hyperlinq.UnitTests.Partitioning.Take
{
    public class AsyncValueEnumerableTests
    {
        ...
        public void Take_With_ValidData_Must_Succeed(int[] source, int count)
        {
            ...
            // Act
            var result = wrapped
                .Take<Wrap.AsyncValueEnumerableWrapper<int>, Wrap.AsyncEnumerator<int>, int>(count);
        ...
        public void Take_Take_With_ValidData_Must_Succeed(int[] source, int count0, int count1)
        {
            ...
            // Act
            var result = wrapped
                .Take<Wrap.AsyncValueEnumerableWrapper<int>, Wrap.AsyncEnumerator<int>, int>(count0)
                .Take(count1);
