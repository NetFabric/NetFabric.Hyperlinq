...
{
    public class SingleOrNullValueReadOnlyListTests
    {
        [Theory]
        ...
        public void SingleOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ValueReadOnlyList.SingleOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ValueReadOnlyList.SingleOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void SingleOrNull_With_Multiple_Should_Throw(int[] source, int _)
        {
            ...
            // Act
            Action action = () => ValueReadOnlyList.SingleOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Multiple_Should_Throw(int[] source, Func<int, long, bool> predicate, int _)
        {
            ...
            // Act
            Action action = () => ValueReadOnlyList.SingleOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped, predicate);
