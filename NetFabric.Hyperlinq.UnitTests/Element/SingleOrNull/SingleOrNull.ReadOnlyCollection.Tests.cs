...
{
    public class SingleOrNullReadOnlyCollectionTests
    {
        [Theory]
        ...
        public void SingleOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ReadOnlyCollection.SingleOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ReadOnlyCollection.SingleOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void SingleOrNull_With_Multiple_Should_Throw(int[] source, int _)
        {
            ...
            // Act
            Action action = () => ReadOnlyCollection.SingleOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Multiple_Should_Throw(int[] source, Func<int, long, bool> predicate, int _)
        {
            ...
            // Act
            Action action = () => ReadOnlyCollection.SingleOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
