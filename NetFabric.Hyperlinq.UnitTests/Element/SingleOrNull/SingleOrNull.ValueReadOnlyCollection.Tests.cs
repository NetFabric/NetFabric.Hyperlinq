...
{
    public class SingleOrNullValueReadOnlyCollectionTests
    {
        [Theory]
        ...
        public void SingleOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ValueReadOnlyCollection.SingleOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ValueReadOnlyCollection.SingleOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void SingleOrNull_With_Multiple_Should_Throw(int[] source, int _)
        {
            ...
            // Act
            Action action = () => ValueReadOnlyCollection.SingleOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrNullPredicate_With_Multiple_Should_Throw(int[] source, Func<int, long, bool> predicate, int _)
        {
            ...
            // Act
            Action action = () => ValueReadOnlyCollection.SingleOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
