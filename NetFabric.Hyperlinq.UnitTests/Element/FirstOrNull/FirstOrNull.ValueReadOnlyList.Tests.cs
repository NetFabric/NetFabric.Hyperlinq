...
{
    public class FirstOrNullValueReadOnlyListTests
    {
        [Theory]
        ...
        public void FirstOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ValueReadOnlyList.FirstOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped);
        ...
        public void FirstOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ValueReadOnlyList.FirstOrNull<Wrap.ValueReadOnlyList<int>, Wrap.ValueReadOnlyList<int>.Enumerator, int>(wrapped, predicate);
