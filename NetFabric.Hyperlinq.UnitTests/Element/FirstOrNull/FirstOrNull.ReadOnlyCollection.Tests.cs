...
{
    public class FirstOrNullReadOnlyCollectionTests
    {
        [Theory]
        ...
        public void FirstOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ReadOnlyCollection.FirstOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void FirstOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ReadOnlyCollection.FirstOrNull<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
