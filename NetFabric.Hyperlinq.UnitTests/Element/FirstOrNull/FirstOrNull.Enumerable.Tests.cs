...
{
    public class FirstOrNullEnumerableTests
    {
        [Theory]
        ...
        public void FirstOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = Enumerable.FirstOrNull<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped);
        ...
        public void FirstOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = Enumerable.FirstOrNull<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped, predicate);
