...
{
    public class FirstOrNullValueReadOnlyCollectionTests
    {
        [Theory]
        ...
        public void FirstOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ValueReadOnlyCollection.FirstOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void FirstOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ValueReadOnlyCollection.FirstOrNull<Wrap.ValueReadOnlyCollection<int>, Wrap.ValueReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
