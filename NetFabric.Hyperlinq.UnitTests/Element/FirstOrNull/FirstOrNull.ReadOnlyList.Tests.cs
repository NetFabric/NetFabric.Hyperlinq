...
{
    public class FirstOrNullReadOnlyListTests
    {
        [Theory]
        ...
        public void FirstOrNull_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ReadOnlyList.FirstOrNull<Wrap.ReadOnlyList<int>, int>(wrapped);
        ...
        public void FirstOrNullPredicate_With_Empty_Return_Default(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            var result = ReadOnlyList.FirstOrNull<Wrap.ReadOnlyList<int>, int>(wrapped, predicate);
