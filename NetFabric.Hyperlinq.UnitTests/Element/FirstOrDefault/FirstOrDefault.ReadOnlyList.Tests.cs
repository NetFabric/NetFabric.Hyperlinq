...
namespace NetFabric.Hyperlinq.UnitTests
{
    public class FirstOrDefaultReadOnlyListTests
    {
        ...
        public void FirstOrDefault_With_Empty_Return_Default(int[] source)
        {
            ...
            // Act
            var result = ReadOnlyList.FirstOrDefault<Wrap.ReadOnlyList<int>, int>(wrapped);
        ...
        public void FirstOrDefaultPredicate_With_Empty_Return_Default(int[] source, Func<int, bool> predicate)
        {
            ...
            // Act
            var result = ReadOnlyList.FirstOrDefault<Wrap.ReadOnlyList<int>, int>(wrapped, predicate);
