    ...
    public class ReadOnlyMemoryTests
    {
        ...
        public void ElementAt_With_OutOfRange_Must_Throw(int[] source)
        {
            ...
            Action actionLess = () => _ = Array
                .ElementAt<int>((ReadOnlyMemory<int>)source.AsMemory(), -1);
            Action actionGreater = () => _ = Array
                .ElementAt<int>((ReadOnlyMemory<int>)source.AsMemory(), source.Length);
        ...
        public void ElementAt_With_ValidData_Must_Succeed(int[] source)
        {
            for (var index = 0; index < source.Length; index++)
            {
                ...
                // Act
                var result = Array
                    .ElementAt<int>((ReadOnlyMemory<int>)source.AsMemory(), index);
