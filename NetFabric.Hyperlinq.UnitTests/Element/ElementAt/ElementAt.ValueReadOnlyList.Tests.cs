...
namespace NetFabric.Hyperlinq.UnitTests
{
    public class ElementAtValueReadOnlyListTests
    {
        ...
        public void ElementAt_With_OutOfRange_Should_Throw(int[] source, int index)
        {
            ...
            // Act
            Action action = () => ValueReadOnlyList.ElementAt<Wrap.ValueReadOnlyList<int>, Wrap.Enumerator<int>, int>(wrapped, index);
        ...
        public void ElementAt_With_ValidData_Should_Succeed(int[] source, int index)
        {
            ...
            // Act
            var result = ValueReadOnlyList.ElementAt<Wrap.ValueReadOnlyList<int>, Wrap.Enumerator<int>, int>(wrapped, index);
