...
namespace NetFabric.Hyperlinq.UnitTests
{
    public class SingleOrDefaultValueEnumerableTests
    {
        ...
        public void SingleOrDefault_With_ValidData_Should_Succeed(int[] source)
        {
            ...
            // Act
            var result = ValueEnumerable.SingleOrDefault<Wrap.ValueEnumerable<int>, Wrap.ValueEnumerable<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrDefaultPredicate_With_ValidData_Should_Succeed(int[] source, Func<int, bool> predicate)
        {
            ...
            // Act
            var result = ValueEnumerable.SingleOrDefault<Wrap.ValueEnumerable<int>, Wrap.ValueEnumerable<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void SingleOrDefault_With_Multiple_Should_Throw(int[] source)
        {
            ...
            // Act
            Action action = () => ValueEnumerable.SingleOrDefault<Wrap.ValueEnumerable<int>, Wrap.ValueEnumerable<int>.Enumerator, int>(wrapped);
        ...
        public void SingleOrDefaultPredicate_With_Multiple_Should_Throw(int[] source, Func<int, bool> predicate)
        {
            ...
            // Act
            Action action = () => ValueEnumerable.SingleOrDefault<Wrap.ValueEnumerable<int>, Wrap.ValueEnumerable<int>.Enumerator, int>(wrapped, predicate);
