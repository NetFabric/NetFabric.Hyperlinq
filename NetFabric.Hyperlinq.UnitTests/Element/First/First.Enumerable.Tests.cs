...
{
    public class FirstEnumerableTests
    {
        [Theory]
        ...
        public void First_With_Empty_Should_Throw(int[] source)
        {
            ...
            // Act
            Action action = () => Enumerable.First<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped);
        ...
        public void FirstPredicate_With_Empty_Should_Throw(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            Action action = () => Enumerable.First<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void First_With_ValidData_Should_Succeed(int[] source, int expected)
        {
            ...
            // Act
            var result = Enumerable.First<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped);
        ...
        public void FirstPredicate_With_ValidData_Should_Succeed(int[] source, Func<int, long, bool> predicate, int expected)
        {
            ...
            // Act
            var result = Enumerable.First<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped, predicate);
