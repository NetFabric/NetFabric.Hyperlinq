...
namespace NetFabric.Hyperlinq.UnitTests
{
    public class SingleEnumerableTests
    {
        ...
        public void Single_With_Empty_Should_Throw(int[] source)
        {
            ...
            // Act
            Action action = () => Enumerable.Single<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped);
        ...
        public void SinglePredicate_With_Empty_Should_Throw(int[] source, Func<int, bool> predicate)
        {
            ...
            // Act
            Action action = () => Enumerable.Single<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void Single_With_ValidData_Should_Succeed(int[] source, int expected)
        {
            ...
            // Act
            var result = Enumerable.Single<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped);
        ...
        public void SinglePredicate_With_ValidData_Should_Succeed(int[] source, Func<int, bool> predicate, int expected)
        {
            ...
            // Act
            var result = Enumerable.Single<Wrap.Enumerable<int>, Wrap.Enumerable<int>.Enumerator, int>(wrapped, predicate);
