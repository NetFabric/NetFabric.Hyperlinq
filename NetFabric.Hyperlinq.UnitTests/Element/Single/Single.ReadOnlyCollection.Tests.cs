...
{
    public class SingleReadOnlyCollectionTests
    {
        [Theory]
        ...
        public void Single_With_Empty_Should_Throw(int[] source)
        {
            ...
            // Act
            Action action = () => ReadOnlyCollection.Single<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SinglePredicate_With_Empty_Should_Throw(int[] source, Func<int, long, bool> predicate)
        {
            ...
            // Act
            Action action = () => ReadOnlyCollection.Single<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
        ...
        public void Single_With_ValidData_Should_Succeed(int[] source, int expected)
        {
            ...
            // Act
            var result = ReadOnlyCollection.Single<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped);
        ...
        public void SinglePredicate_With_ValidData_Should_Succeed(int[] source, Func<int, long, bool> predicate, int expected)
        {
            ...
            // Act
            var result = ReadOnlyCollection.Single<Wrap.ReadOnlyCollection<int>, Wrap.ReadOnlyCollection<int>.Enumerator, int>(wrapped, predicate);
