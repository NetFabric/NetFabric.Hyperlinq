...
{
    public class SingleReadOnlyListTests
    {
        [Theory]
        ...
        public void Single_With_Empty_Should_Throw(int[] source)
        {
            ...
            // Act
            Action action = () => ReadOnlyList.Single<Wrap.ReadOnlyList<int>, int>(wrapped);
        ...
        public void SinglePredicate_With_Empty_Should_Throw(int[] source, Func<int, bool> predicate)
        {
            ...
            // Act
            Action action = () => ReadOnlyList.Single<Wrap.ReadOnlyList<int>, int>(wrapped, predicate);
        ...
        public void Single_With_ValidData_Should_Succeed(int[] source, int expected)
        {
            ...
            // Act
            var result = ReadOnlyList.Single<Wrap.ReadOnlyList<int>, int>(wrapped);
        ...
        public void SinglePredicate_With_ValidData_Should_Succeed(int[] source, Func<int, bool> predicate, int expected)
        {
            ...
            // Act
            var result = ReadOnlyList.Single<Wrap.ReadOnlyList<int>, int>(wrapped, predicate);
