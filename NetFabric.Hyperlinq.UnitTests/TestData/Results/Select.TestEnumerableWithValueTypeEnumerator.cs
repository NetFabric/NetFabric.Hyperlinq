...
static partial class GeneratedExtensionMethods
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueEnumerableExtensions.SelectEnumerable<GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_, TestEnumerableWithValueTypeEnumerator<TestValueType>.Enumerator, TestValueType, TestReferenceType, NetFabric.Hyperlinq.FunctionWrapper<TestValueType, TestReferenceType>> Select(this GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_ source, System.Func<TestValueType, TestReferenceType> selector)
        => NetFabric.Hyperlinq.ValueEnumerableExtensions.Select<GeneratedExtensionMethods.AsValueEnumerable_TestEnumerableWithValueTypeEnumerator_TestValueType_, TestEnumerableWithValueTypeEnumerator<TestValueType>.Enumerator, TestValueType, TestReferenceType, NetFabric.Hyperlinq.FunctionWrapper<TestValueType, TestReferenceType>>(source, selector);
}
