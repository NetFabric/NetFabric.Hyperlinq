...
{
    public class CountReadOnlyListTests
    {
        [Theory]
        ...
        public void Count_With_ValidData_Should_Succeed(int[] source, int expected)
        {
            ...
            // Act
            var result = ReadOnlyList.Count<Wrap.ReadOnlyList<int>, int>(wrapped);
        ...
        public void CountPredicate_With_ValidData_Should_Succeed(int[] source, Func<int, bool> predicate, int expected)
        {
            ...
            // Act
            var result = ReadOnlyList.Count<Wrap.ReadOnlyList<int>, int>(wrapped, predicate);
