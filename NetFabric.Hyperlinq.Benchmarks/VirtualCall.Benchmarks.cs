...
namespace NetFabric.Hyperlinq
{
    ...
    public class VirtualCallBenchmarks
    {
        ...
        public int Array_Interface() => 
            CountInterface(array, (_, __) => true);

        [BenchmarkCategory("Array")]
        [Benchmark]
        public int Array_Class() => 
            CountArray(array, (_, __) => true);

        [BenchmarkCategory("Array")]
        [Benchmark]
        public int Array_GenericConstraint() => 
            CountConstraint(array, (_, __) => true);

        [BenchmarkCategory("Array")]
        [Benchmark]
        public int Array_GenericConstraintWrapper() => 
            CountConstraintWrapper(array, (_, __) => true);

        [BenchmarkCategory("List")]
        [Benchmark(Baseline = true)]
        public int List_Interface() => 
            CountInterface(list, (_, __) => true);

        [BenchmarkCategory("List")]
        [Benchmark]
        public int List_Class() => 
            CountList(list, (_, __) => true);

        [BenchmarkCategory("List")]
        [Benchmark]
        public int List_GenericConstraint() => 
            CountConstraint(list, (_, __) => true);

        [BenchmarkCategory("List")]
        [Benchmark]
        public int List_GenericConstraintWrapper() => 
            CountConstraintWrapper(list, (_, __) => true);

        public static int CountInterface<TSource>(IReadOnlyList<TSource> source, Func<TSource, long, bool> predicate)
        {
            var count = 0;
        ...
        public static int CountArray<TSource>(TSource[] source, Func<TSource, long, bool> predicate)
        {
            var count = 0;
        ...
        public static int CountList<TSource>(List<TSource> source, Func<TSource, long, bool> predicate)
        {
            var count = 0;
            for (var index = 0; index < source.Count; index++)
            {
        ...
        public static int CountConstraint<TSource>(TSource[] source, Func<TSource, long, bool> predicate)
            => Count<TSource[], TSource>(source, predicate);

        public static int CountConstraint<TSource>(List<TSource> source, Func<TSource, long, bool> predicate)
            => Count<List<TSource>, TSource>(source, predicate);

        public static int CountConstraintWrapper<TSource>(List<TSource> source, Func<TSource, long, bool> predicate)
            => Count<ListWrapper<TSource>, TSource>(new ListWrapper<TSource>(source), predicate);

        public static int CountConstraintWrapper<TSource>(TSource[] source, Func<TSource, long, bool> predicate)
            => Count<ArrayWrapper<TSource>, TSource>(new ArrayWrapper<TSource>(source), predicate);
        
        public static int Count<TEnumerable, TSource>(TEnumerable source, Func<TSource, long, bool> predicate)
